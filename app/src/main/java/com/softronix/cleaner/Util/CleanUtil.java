...
public class CleanUtil {
    ...
    public static void freeAllAppsCache(final Handler handler) {
        ...
        try {
            ...
            freeStorageAndNotify.invoke(pm, freeStorageSize, new IPackageDataObserver.Stub() {
                ...
                public void onRemoveCompleted(String packageName, boolean succeeded) throws RemoteException {
                    Message msg = handler.obtainMessage(JunkCleaner.MSG_SYS_CACHE_CLEAN_FINISH);
                    msg.sendToTarget();
                }
            });
            hanged = false;
        ...
        if (hanged) {
            ...
            bundle.putBoolean(JunkCleaner.HANG_FLAG, true);
            msg.setData(bundle);
            msg.sendToTarget();
        }
    }
    ...
    public static void freeJunkInfos(ArrayList<JunkInfo> junks, final Handler handler) {
        ...
        Message msg = handler.obtainMessage(JunkCleaner.MSG_OVERALL_CLEAN_FINISH);
        msg.sendToTarget();
    }
}
